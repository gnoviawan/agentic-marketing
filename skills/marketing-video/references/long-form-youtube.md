...
## Purpose
Develop YouTube channel strategy -- positioning, content pillars, video structure, SEO optimization, thumbnail design, and growth planning.

## Process

1. **Load Context**: Read brand positioning and audience from SOSTAC
2. **Assess Current State**: Check for existing YouTube strategy or channel presence
3. **Define Strategy**: Channel positioning, pillars, cadence, branding
4. **Apply Structure**: Hook-intro-body-CTA framework for every video
5. **Optimize for SEO**: Titles, descriptions, tags, chapters, thumbnails
6. **Deliver Output**: Full strategy document or specific video script/optimization
...
## 2. Video Structure (Hook-Intro-Body-CTA)
...
- Open loops ("I'll show you that in a minute")
- Visual variety every 30-60 seconds
- Section transitions with graphics
- Story arcs within educational content
- Mid-roll CTAs ("If this is helpful, hit subscribe")
...
For detailed thumbnail frameworks, see `./frameworks/thumbnail-design.md`.

---

## 5. Shorts Cross-Strategy

Shorts drive subscriber growth; long-form drives watch time and revenue.

- Use Shorts to tease long-form content
- Clip the best 30-60 second moments from long-form as Shorts
- Track subscriber source to measure Shorts-to-long-form pipeline
- Frame long-form center-safe for vertical cropping
...
Deliver:
- **YouTube channel strategy** (`youtube-strategy-{YYYY-MM-DD}.md`)
- **Video script** with timecodes and thumbnail concept
- **SEO optimization** for existing videos (title, description, tags, chapters)
- **Thumbnail concept** with visual direction
- **Save to**: `./brands/{brand-slug}/channels/video/content/` or campaign path