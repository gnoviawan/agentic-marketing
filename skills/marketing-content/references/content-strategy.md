...
## Overview
Define the strategic foundation for content marketing: pillars, voice, tone, and funnel mapping.
...
1. List everything the brand can credibly teach or opine on
2. List every question, pain point, and aspiration the target audience has
3. Find the overlap and group into 3-5 themes
4. Validate against competitors -- can the brand differentiate within each pillar?
...
## 4. Content Types and When to Use Each

**Blog Posts (800-2000 words)** -- Awareness, SEO, consistent cadence. Formats: how-to, listicles, opinion, news analysis, roundups, FAQs. Publish 2-4/week for growth, minimum 1/week. Target a keyword cluster per post.
...
**Case Studies (1000-2500 words)** -- Consideration and decision stage. See `./frameworks/case-study-framework.md` for the complete framework.
...
**Podcasts** -- Thought leadership, guest relationships, audience loyalty. Formats: solo (15-25 min), interview (30-45 min), co-hosted (20-40 min). Launch with 3-5 episodes, weekly or biweekly.

**Webinars (30-60 min)** -- Lead generation, product demos, expert positioning. Structure: 5 min intro, 35-45 min content, 10-15 min Q&A. Promote 2-3 weeks ahead. Repurpose as on-demand, blog, clips.
...
**Content Strategy Document** (`content-strategy-{YYYY-MM-DD}.md`):
- Strategic Alignment (SOSTAC)
- Content Pillars
...
Save to the resolved meta content path.