...
## Overview
Use browser automation to research content gaps, audience questions, and competitive content. Check `./brands/{brand-slug}/sostac/00-auto-discovery.md` first -- data may already be collected.
