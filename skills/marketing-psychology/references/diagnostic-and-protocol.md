# Diagnostic and Response Protocol

How to use this skill and what good output looks like.
...
| Problem | Likely Root Cause | Route |
|---|---|---|
| Low conversion rate on landing page | Missing social proof, weak loss framing, unclear CTA | Cognitive Biases, Psychology by Context |
| High cart abandonment | Status quo bias, last-minute doubt, insufficient commitment | Cognitive Biases, Behavioral Design |
| Pricing feels "too expensive" | No anchor, no decoy, wrong framing | Pricing Psychology |
| Low trial signups | High perceived friction, weak scarcity, no social proof | Behavioral Design, Cialdini Principles |
| High churn after trial | Poor onboarding (no aha moment), weak commitment hooks | Behavioral Design, Cognitive Biases |
| Ad copy not converting | Wrong emotional framing, no loss aversion, weak hook | Copy Frameworks, Cognitive Biases |
| Weak email open rates | No curiosity gap, wrong timing, no pattern interrupt | Copy Frameworks, Psychology by Context |
| "Why don't customers buy?" | Disconnect between their JTBD and what we're selling | Strategic Mental Models |
...
2. Run through each capability as a checklist.
...
1. **Read brand context** when available, then continue from the best available context. The `product-marketing-context.md` is especially valuable because it contains the customer's own language, objections, and mental models.
...
3. **Diagnose first**: Use the Quick Reference Table to identify the highest-leverage psychological principles for the stated problem.
