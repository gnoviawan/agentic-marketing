...
> Capability prompt for marketing-influencer skill. Load when user needs tier selection or platform strategy.
...
When selecting tier and platform mix:

1. **Audience match**: Where does target audience spend time? What content format resonates?
2. **Budget constraints**: Tight budget = nano/micro volume. Larger budget = tier diversity.
3. **Campaign objective**: Awareness = macro/reach. Conversion = nano/micro/trust.
4. **Content needs**: UGC for ads = nano creators. Long-form education = YouTube creators.
5. **Timeline urgency**: Macro creators have longer lead times. Nano/micro are faster to activate.

---

## Outcome

Deliver a tier and platform recommendation with rationale, budget allocation, and expected performance based on benchmarks from `./references/benchmarks.md`.