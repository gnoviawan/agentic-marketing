...
Every `product-marketing-context.md` must include a freshness header:
...
**How to flag:** When working in any specialist skill, if `product-marketing-context.md` seems misaligned with reality, add a comment:

> **Note:** The product-marketing-context.md may need updating — [specific signal observed]. Consider running the product-marketing-context skill to refresh.
