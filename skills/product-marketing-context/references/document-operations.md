...
**Save location:** `./brands/{brand-slug}/product-marketing-context.md`
...
```
Saved to: ./brands/{brand-slug}/product-marketing-context.md
...
If anything in `product-marketing-context.md` expands or contradicts `brand-context.md`, update `brand-context.md` to stay consistent. They should agree, not diverge.
